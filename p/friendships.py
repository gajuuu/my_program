...
Everything is printed in alphabetical order.
The following commands are possible.

P: to print all the friendship data
A + [name1, name2, ...]: to add new friendship among the namelist
F + [name1]: to print name1's friends
C + [name1, name2]: to print common friends of name1 and name2
...
def read_friendship_network(filename):
    ...
    # Choose dictionary and initialize it
    network = {}
...
def print_command(network, namelist):
    ...
    for key_name in sorted(network):
        print(key_name)
        for name in sorted(network[key_name]):
            print(f"- {name}")
