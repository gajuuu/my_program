...
void University::sign_up(Params params)
{
    ...
    accounts_.at(account)->set_current(courses_.at(code));
}
...
void University::complete(Params params)
{
    ...
    accounts_.at(account)->set_complete(courses_.at(code));
}
...
void University::print_signups(Params params)
{
    ...
    courses_.at(code)->print_enrolled_students();
}
