 ...
 * -------------
 * Class representing the action logic of the game.
 * For the purpose of resetting the color infomation of the game board,
 * the method "void reset_board();" was added to the template file.
 *
 * */
...
public:
    ...
    // Resets the color infomation of the game board.
    void reset_board();
